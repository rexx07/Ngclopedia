...
using Ngclopedia.Infrastructure.Common.Extensions;
using OrchardCore.Localization;

namespace Ngclopedia.Infrastructure.Localization;

/// <summary>
///     Provides PO files for Ngclopedia Localization.
/// </summary>
public class NgclopediaPoFileLocationProvider : ILocalizationFileLocationProvider
{
    private readonly IFileProvider _fileProvider;
    private readonly string _resourcesContainer;

    public NgclopediaPoFileLocationProvider(IHostEnvironment hostingEnvironment,
